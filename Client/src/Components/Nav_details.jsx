      ...
      <div className="container p-3">
        ...
        <div className="card w-full sm:w-4/5 md:w-3/4 lg:w-2/3 mx-auto card-custom">
          <div className="card-body rounded p-4" style={{ backgroundColor: "#fffdd0" }}>
            ...
            <h4 className="card-subtitle text-center fw-bold text-base sm:text-lg md:text-xl">Tenants/Want Room</h4>

            <ul className="m-3 text-sm sm:text-base md:text-lg font-semibold">
              <li className="mb-2">
                <h5>20%</h5>
                <span>Rooms</span>
              </li>
